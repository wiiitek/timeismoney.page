...
class AppComponent {
    constructor() {
        this.title = 'timeismoney';
    }
}
AppComponent.ɵfac = function AppComponent_Factory(t) { return new (t || AppComponent)(); };
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 10, vars: 1, consts: [[1, "container"], [1, "row"], [1, "col-1-sm", "col-3"], [1, "col-10-sm", "col-6"], [1, "main"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
